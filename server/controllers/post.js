...
//     const updatedPost=await PostMessage.findByIdAndUpdate(id,post,{new:true});//güncellenicek olan postun id istiyo update olmus alanları ıstıyo post yerleştirdik randevu verıyı dondurmek ıcın nev:true deriz
